...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        // Insert Departments
        const departments = yield prisma.departments.createMany({
            data: [
        ...
        // Insert Patients
        const patients = yield prisma.patients.createMany({
            data: [
        ...
        // Insert Doctors
        const doctors = yield prisma.doctors.createMany({
            data: [
        ...
        // Insert Rooms
        const rooms = yield prisma.rooms.createMany({
            data: [
        ...
        // Insert Appointments
        const appointments = yield prisma.appointments.createMany({
            data: [
        ...
        const medicalHistory = yield prisma.medicalHistory.createMany({
            data: [
        ...
        // Insert Diagnosis
        const diagnosis = yield prisma.diagnosis.createMany({
            data: [
        ...
        // Insert Medications
        const medications = yield prisma.medications.createMany({
            data: [
        ...
        // Insert Treatments
        const treatments = yield prisma.treatments.createMany({
            data: [
        ...
        // Insert Insurance
        const insurance = yield prisma.insurance.createMany({
            data: [
        ...
        // Insert Lab Tests
        const labTests = yield prisma.labTests.createMany({
            data: [
        ...
        // Insert Billing
        const billing = yield prisma.bills.createMany({
            data: [
